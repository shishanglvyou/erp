  			...
  			<div style="border:1px solid #cecece;">
				...
				<table width="100%"  border="0" cellpadding="0" cellspacing="0">
				    <tr  bgcolor="#FFFFFF">
				      ...
				      <td width="32%">
				      	<input type="text" size="25" regr="^\w{6,8}$" tip="请输入6到8位用户名"/>
				      </td>
				      <td width="18%"align="center"><font color="red">*</font>真实姓名</td>
				      <td width="32%">
				      	<input type="text" size="25" reg="^[\u4e00-\u9fa5]{2,10}$" tip="请输入2到10位的真实姓名"/>
					  </td>
				    </tr>
				    <tr bgcolor="#FFFFFF">
					  <td colspan="4">&nbsp;</td>
				    ...
				    <tr  bgcolor="#FFFFFF">
				      ...
				      <td>
				      	<input type="text" size="25" regr="^[\w!@#$%^&*()_]{6,8}$" tip="请输入6到8位密码"/>
				      </td>
